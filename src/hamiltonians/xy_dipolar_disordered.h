#ifndef MCPP_XY_HAMILTONIAN_DIPOLE_DISORDERED_H
#define MCPP_XY_HAMILTONIAN_DIPOLE_DISORDERED_H
...
class XY_Dipole_Disordered : public XY_Hamiltonian{
public:
    XY_Dipole_Disordered (alps::Parameters const& params) : 
...
private:
    ...
    void Init_Lookup_Tables(int DISORDER_SEED){
        ...
        //Position disorder 
        std::vector<double> dR(2*N);
        if(position_std_dev>0.) {
...
#endif //MCPP_XY_HAMILTONIAN_DIPOLE_DISORDERED_H
